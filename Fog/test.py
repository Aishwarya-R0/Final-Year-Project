...
#
# # absolute path
# src_path = r"C:/Users/angel/Downloads/recording1.wav"
# dst_path = r"C:/Users/angel/Downloads/Depression Recogntion/recording1.wav"
...
def plot_audio_spectrogram(audio_path, binsize=2 ** 10, plot_path=None, argv='', colormap="jet"):
    ...
    plt.figure(
        figsize=(time_bins / 100, freq_bins / 100))  # resolution equal to audio data resolution, dpi=100 as default
    ...
    plt.xticks(x_locations,
               ["%.02f" % l for l in ((x_locations * len(samples) / time_bins) + (0.5 * binsize)) / sample_rate])
...
def path_to_tensor(img_path, width=224, height=224):
    ...
    print(img_path)
    img = keras.utils.load_img(img_path, target_size=(width, height))
...
def main():
    ...
    #
    #     filename = filedialog.askopenfilename(title='open')
    #src_path = r"/check/recording1.wav"
    #dst_path = r"./recording1.wav"
...
#    plt.show() 
    ...
    print('Given Audio Predicted is : ' + str([np.argmax(pred)]))
